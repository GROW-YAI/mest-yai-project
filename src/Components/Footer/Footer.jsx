      ...
      <footer className="footer">
        ...
        <div className="footer-container container">
          ...
          <div className="footer-column">
            ...
            <a href="https://www.instagram.com/mmbshygienicsocks?igsh=N2F0NW13Nnptc3M3" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
            <a href="https://www.linkedin.com/in/mmb-s-hygienic-socks-10a1b3353?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
          </div>
          </div>
        </div>
